// base file - https://github.com/YunzhuLi/PyFleX/blob/master/bindings/scenes/yz_softbody.h
...
public:
	...
	virtual void Initialize(py::array_t<float> scene_params, int thread_idx = 0)
	{
	    ...
	    // Add instance
		char box_path[100];
		make_path(box_path, "/bindings/softgym_scenes/meshes/box.ply");
